...
urlpatterns = [
    ...
    path('departamentoinstance/<int:pk>', views.DepartamentoInstanceDetailView.as_view(), name='departamentoinstance_detail'),
...
urlpatterns += [
    ...
    path('departamentoinstance/<int:pk>/update/', views.DepartamentoInstanceUpdate.as_view(), name='departamentoinstance_update'),
    path('departamentoinstance/<int:pk>/delete/', views.DepartamentoInstanceDelete.as_view(), name='departamentoinstance_delete'),
